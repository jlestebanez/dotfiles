...
sudo scutil --set ComputerName "metalbrain"
sudo scutil --set HostName "metalbrain"
sudo scutil --set LocalHostName "metalbrain"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "metalbrain"
...
defaults write NSGlobalDomain AppleHighlightColor -string "0.776500 0.776500 0.776500"

# Set sidebar icon size to medium
defaults write NSGlobalDomain NSTableViewDefaultSizeMode -int 1

# Show scrollbars omn scrolling
...
# Remote icons for hard drives, servers, and removable media on the desktop
...
# Set medium delay for spring loading
